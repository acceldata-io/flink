...
/**
 * Counterpart of hive's org.apache.hadoop.hive.ql.ddl.table.create.CreateTableDesc, but only
 * contains the properties needed for "insert overwrite directory".
 */
